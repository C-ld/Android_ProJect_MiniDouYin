...
public class MyLoadDay extends View {
    ...
    public MyLoadDay(Context context){
        this(context, null);
    }

    public MyLoadDay(Context context, @Nullable AttributeSet attrs){
        this(context, attrs, 0);
    }

    public MyLoadDay(Context context, @Nullable AttributeSet attrs, int defStyleAttr){
...
//        }
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        canvas.drawCircle(centerX+starRadius*(float) Math.cos(starAng+Math.PI*2/6),centerY+starRadius*(float) Math.sin(starAng+Math.PI*2/6),30,starPaint);
        canvas.drawCircle(centerX+starRadius*(float) Math.cos(starAng+Math.PI*4/6),centerY+starRadius*(float) Math.sin(starAng+Math.PI*4/6),30,starPaint);
        canvas.drawCircle(centerX+starRadius*(float) Math.cos(starAng+Math.PI*6/6),centerY+starRadius*(float) Math.sin(starAng+Math.PI*6/6),30,starPaint);
        canvas.drawCircle(centerX+starRadius*(float) Math.cos(starAng+Math.PI*8/6),centerY+starRadius*(float) Math.sin(starAng+Math.PI*8/6),30,starPaint);
        canvas.drawCircle(centerX+starRadius*(float) Math.cos(starAng+Math.PI*10/6),centerY+starRadius*(float) Math.sin(starAng+Math.PI*10/6),30,starPaint);
